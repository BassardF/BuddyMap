...
phonecatControllers.controller('LoginCtrl3', function ($scope, $location, $rootScope, user) {
  ...
  frLabels = {
    ...
    registrationError : "Une erreur est survenue pendant la cr�ation de votre compte, veuillez r�essayer",
    registrationConflictError : "Ce compte existe d�j� !",
    loginError : "Votre compte a �t� cr�� mais une erreur est survenue lors de votre connexion, veuillez vous connecter"
  };
